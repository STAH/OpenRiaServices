	...
	public partial class CSharpDomainContextGenerator
	{
		...
		internal override void Initialize()
		{
			...
			this.DomainContextTypeName =
				CodeGenUtilities.GetSafeName(DomainContextGenerator.GetDomainContextTypeName(this.DomainServiceDescription));
		}
		...
		internal string GetEntitySetOperationsEnumValue(Type entityType)
		{
			...
			else
			{
				...
				if (canEdit)
				{
					entitySetOperationsEnumValue += (entitySetOperationsEnumValue == null ? string.Empty : " | ") +
					                                "EntitySetOperations.Edit";
				}
				if (canDelete)
				{
					entitySetOperationsEnumValue += (entitySetOperationsEnumValue == null ? string.Empty : " | ") +
