...
namespace OpenRiaServices.DomainServices.Tools.TextTemplate.CSharpGenerators
{
	...
	public partial class CSharpClientCodeGenerator
	{
		...
		{
			get { return this._entityProxyGenerator; }
		}
		...
		{
			get { return this._complexObjectGenerator; }
		}
		...
		{
			get { return this._domainContextGenerator; }
		}
		...
		{
			get { return this._webContextGenerator; }
		}
		...
		{
			get { return this._enumGenerator; }
		}
		...
		protected override string GenerateCode()
		{
			...
			{
				this.CodeGenerationHost.LogError(string.Format(CultureInfo.CurrentCulture,
					TextTemplateResource.NonCSharpLanguageNotSupported));
				return null;
			}
